...
const SERVICIOS = ["Corte de cabello", "Barba", "Corte + barba", "Tinte"];

const NEGOCIO_ID = "055ce69b-63c8-45a0-b539-1c06553a9c24";
...
export default function AgendarPage() {
  ...
  Volver al inicio
          ...
          <p className="text-sm text-zinc-500 mt-1">Barberia El Corte</p>
        </div>
