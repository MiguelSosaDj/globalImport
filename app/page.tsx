  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 pt-28 pb-20 gap-8">
        ...
        <h1 className="text-7xl font-bold max-w-4xl leading-[1.05] tracking-tight text-slate-900">
        ...
        <div className="flex items-center gap-10 mt-8 pt-8 border-t border-slate-200">
          <div className="flex flex-col items-center gap-1">
            <span className="text-2xl font-bold text-slate-900">2,400+</span>
            <span className="text-xs text-slate-500">citas agendadas</span>
          </div>
          <div className="flex flex-col items-center gap-1">
            <span className="text-2xl font-bold text-slate-900">180+</span>
            <span className="text-xs text-slate-500">negocios activos</span>
          </div>
          <div className="flex flex-col items-center gap-1">
            <span className="text-2xl font-bold text-slate-900">98%</span>
            <span className="text-xs text-slate-500">tasa de confirmación</span>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-8 pb-24">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col gap-4 hover:border-blue-300 hover:shadow-md transition-all duration-300">
      ...
      {/* CTA final */}
      <section className="flex flex-col items-center text-center px-6 pb-32 gap-6">
        <div className="max-w-2xl mx-auto w-full rounded-3xl border border-blue-100 bg-blue-50 p-16">
          ...
          <Link
            href="/registro"
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-8 py-3.5 rounded-full transition-all duration-300 hover:scale-105"
          >
            Crear cuenta gratis
          </Link>
        </div>
